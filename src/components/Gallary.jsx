...
function Gallary() {
  return (
    <div className='gallery-cont'>
      ...
      <section>
        <h2>OUR GALLERY</h2>
        <p>Welcome to our gallery page! Take a look at some of the amazing dishes we offer. Our talented chefs use only the freshest ingredients to create a menu that satisfies every palate. Browse through our gallery and get a taste of what we have to offer.</p>
      </section>
